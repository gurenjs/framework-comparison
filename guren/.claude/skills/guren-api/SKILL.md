...
> The authoritative signature-level API reference lives in `.claude/rules/*.md` (each file's `globs` frontmatter states the paths it covers); this skill is a subsystem tour for interactive Q&A.
